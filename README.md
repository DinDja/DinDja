...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=22&duration=2800&pause=600&color=0A66C2&center=true&vCenter=true&width=900&lines=Full+Stack+Developer;Enterprise+%26+Public+Sector+Systems;React+Three+Fiber+%7C+3D+Web;Electron+%7C+Next.js+%7C+Cloud;AI+Integration+%7C+NVIDIA+NIM" alt="Typing SVG"/>
  </a>
</p>
...
Atualmente expandindo para **3D Web e aplicações desktop** — construindo um editor 3D completo com Three.js, React Three Fiber, física em tempo real (Rapier3D) e integração de IA (NVIDIA NIM).
